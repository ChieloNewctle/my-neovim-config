...
keymap('n', '<space>i', ':<C-u>CocList -I symbols<CR>', opts)
keymap('n', '<space>s', ':<C-u>CocList searchhistory<CR>', opts)
keymap('n', '<space>c', ':<C-u>CocList cmdhistory<CR>', opts)
keymap('n', '<space>y', ':<C-u>CocList yank<CR>', opts)
